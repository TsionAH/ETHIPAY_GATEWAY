...
function LoginForm() {
  ...
  const registerFormClassName = `form-box register${
    isActive ? " active" : ""
  }`;
    ...
    <div className="auth-shell">
      ...
      <div className="toggle-box">
        <div className={toggleLeftClassName}>
          ...
          <button className="button register-button" onClick={() => setIsActive(true)}>
            Register
          </button>
        </div>
        <div className={toggleRightClassName}>
          ...
          <button className="button login-button" onClick={() => setIsActive(false)}>
            Login
          </button>
        </div>
      </div>
